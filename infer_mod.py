...
# 23.5.16 调试示例程序，找不到img1这个文件夹
print('in infer_mot.py, file', __file__)
# in infer_mot.py, file ./tools/infer_mot.py
print('in infer_mot.py, os.path.join', os.path.join(__file__, *(['..'] * 2)))
# in infer_mot.py, os.path.join ./tools/infer_mot.py/../..

# add python path of PadleDetection to sys.path
parent_path = os.path.abspath(os.path.join(__file__, *(['..'] * 2)))

print('in infer_mot.py, parent_path', parent_path)
# in infer_mot.py, parent_path /home/aistudio/work/PaddleDetection
